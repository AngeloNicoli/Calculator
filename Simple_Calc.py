...
def Calculator_Gui():
    button_1 =  Button(root, text="1", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(1))
    button_2 =  Button(root, text="2", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(2))
    button_3 =  Button(root, text="3", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(3))
    button_4 =  Button(root, text="4", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(4))
    button_5 =  Button(root, text="5", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(5))
    button_6 =  Button(root, text="6", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(6))
    button_7 =  Button(root, text="7", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(7))
    button_8 =  Button(root, text="8", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(8))
    button_9 =  Button(root, text="9", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(9))
    button_0 =  Button(root, text="0", padx=40, pady=20,bg="#3e3e42",fg='white', command=lambda: button_click(0))
    ...
    button_point= Button(root, text=".",bg="#043738",fg='white',  padx=40, pady=20, command= button_division)
...
def SciCalculator_Gui():
    ...
    button_100.grid(row=0,column=40)
